...
function CreatePrivateGame() {
    ...
    return (
        <div>
            ...
            <Button variant="contained" sx={{ ml: 1, height: 56, width: 200, background: "#4abd46", ":hover": { background: "#368a33" }, marginTop: 2 }} onClick={handleModal}>Create a private game</Button>
            <Modal
